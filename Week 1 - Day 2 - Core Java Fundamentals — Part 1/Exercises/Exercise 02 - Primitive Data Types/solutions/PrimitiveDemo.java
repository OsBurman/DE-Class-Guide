...
public class PrimitiveDemo {
    ...
    public static void main(String[] args) {
         ...
         * - Use byte: Only when memory is extremely critical (e.g., array of millions
         * of values)
         ...
         * - Use int: DEFAULT for whole numbers. Range of ~2.1 billion handles most
         * cases.
         * - Use long: When you need very large numbers (timestamps, IDs, file sizes,
         * very large calculations)
         * Timestamps in milliseconds require long. IDs that exceed int range require
         * long.
         * 
         * Problem with byte for world population:
         * World population is ~8 billion, but byte max is only 127. You'd need int or
         * long.
         * 
         ...
         * - Double is usually default because it provides sufficient precision for most
         * applications.
         * - Use float only when: memory is critical (graphics, huge arrays), or
         ...
         * - In large applications, this can matter significantly (especially in
         * memory-constrained systems)
         * 
         * 5. Default Values:
         * - Default int at class level = 0
         * - Default boolean at class level = false
         * - Default char at class level = '\u0000' (the null character, Unicode value
         * 0)
         */
    }
}
