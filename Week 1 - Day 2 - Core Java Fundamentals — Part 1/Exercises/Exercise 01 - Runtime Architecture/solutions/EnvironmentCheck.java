...
public class EnvironmentCheck {
    ...
    public static void main(String[] args) {
        ...
        // Added Java runtime name to show the implementation (e.g., OpenJDK Runtime
        // Environment)
         ...
         * ANSWER: The JVM (Java Virtual Machine) is the virtual machine that executes
         * Java bytecode.
         * It's the core engine that interprets bytecode into machine-specific
         * instructions.
         * The JRE (Java Runtime Environment) includes the JVM plus all the standard
         * Java class libraries
         * (like java.lang, java.util, etc.) and other runtime components. The JRE is
         * what end-users
         * need to run Java programs. The JVM is what's inside the JRE doing the
         * execution.
         * 
         * 2. Why does Java have a JDK separate from the JRE?
         * ANSWER: The JDK (Java Development Kit) is for developers who are writing Java
         * code.
         ...
         * End-users who just want to run Java programs only need the JRE, not the
         * compiler and other
         * development tools. This keeps the download size smaller for end-users.
         * 
         * 3. What is bytecode, and why is it important?
         * ANSWER: Bytecode is an intermediate instruction format created when you
         * compile Java source code.
         * When you run "javac MyProgram.java", it creates "MyProgram.class" containing
         * bytecode.
         * Bytecode is not human-readable (it's binary), but it's also not specific to
         * any platform.
         * It's platform-neutral. Bytecode is important because:
         * - It enables platform independence: the same .class file works on Windows,
         * Mac, Linux, etc.
         * - It enables security: the JVM can verify bytecode before executing it
         * - It enables performance: the JVM can optimize bytecode at runtime using
         ...
         * d. On any other platform, as long as there's a JVM for that platform, you can
         * run "java MyProgram"
         * e. That platform's JVM interprets the bytecode into platform-specific machine
         * code
         * Result: The same .class file runs on Windows, macOS, Linux, etc. without
         * recompilation.
         * 
         * 5. Can you run a .class file created on one platform on a different platform?
         * ANSWER: Yes! That's the whole point of bytecode and the JVM. The bytecode is
         * platform-independent.
         * A .class file created on Windows can be copied to macOS or Linux and run
         * there, as long as
         ...
         * You can't do this with languages like C or C++ where you compile to machine
         * code for a specific
         * platform. That's what makes Java's approach special and one of its key
         * advantages.
         */
    }
}
